...
dune exec ../../lib_protocol_compiler/replace.exe ../../lib_protocol_compiler/dune_protocol.template.v2 dune.inc ../../lib_protocol_compiler/final_protocol_versions ${version}_${short_hash}
